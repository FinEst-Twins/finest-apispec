...
class TestUC05PeopleCounterController(BaseTestCase):
    """UC05PeopleCounterController integration test stubs"""

    def test_peoplecounter_v1_post(self):
        """Test case for peoplecounter_v1_post

        adds entry/exit count observations to UoP
        """
        EventNotificationAlert = EventNotificationAlert()
        response = self.client.open(
            '/FinEst-Twins/Finest-Platform-Services/1.0.0/peoplecounter/v1',
            method='POST',
